...
@section('title') RPA01 @endsection
@section('linkCss')
    <!-- link css -->
    <style>
...
@endsection
    ...
    @section('supTitle') Responsabilités Pédagogique et Administratives 01 @endsection
    @section('description') Responsabilités Pédagogique et Administratives d'un département, d'une filiére @endsection

@section('ContanierForm')

<form action="{{route('RPA01.store' , $id )}}" enctype="multipart/form-data" method="POST"
